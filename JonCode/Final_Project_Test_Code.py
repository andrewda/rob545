...
def run_training(genomes, config):
    ...
    game_map = pygame.image.load('training_track.png').convert()  # Convert Speeds Up A Lot
...
def run_testing(genomes,config,track_num):
    # Empty Collections For Nets and Cars
    nets = []
    cars = []
    ...
    if track_num == 1:
        track = 'testing_track1.png'
    elif track_num == 2:
        track = 'testing_track2.png'
    elif track_num == 3:
        track = 'testing_track3.png'
    elif track_num == 4:
        track = 'testing_track4.png'
    elif track_num == 5:
        track = 'testing_track5.png'
    ...
    while True:
        ...
        # Display Info
        text = generation_font.render("Best Genome from EANN on Testing Track " + str(track_num), True, (0, 0, 0))
        text_rect = text.get_rect()
...
if __name__ == "__main__":
    ...
    population.run(run_training, 40)  # Uncomment This section to train

    # Run this section to test best genome
    genome_path = "Winner.pkl"

    with open(genome_path, "rb") as f:
        genomes = [pickle.load(f)]
    # run_testing(genomes, config, 5)

for x in range(5):
    track_num = x + 1
    run_testing(genomes, config, track_num)
